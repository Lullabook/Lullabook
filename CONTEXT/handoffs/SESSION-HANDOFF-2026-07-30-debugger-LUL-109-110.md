...
**Pipeline state:** both tickets have been moved to **Review Ready** in Linear and read back successfully. GitHub Issues Sync is enabled; no GitHub issue write was made.
...
- **LUL-109** — `Review Ready`, labels: `Review Ready`, `rls`, `Feature`.
- **LUL-110** — `Review Ready`, labels: `Review Ready`, `release-gate`, `native`, `Feature`.
