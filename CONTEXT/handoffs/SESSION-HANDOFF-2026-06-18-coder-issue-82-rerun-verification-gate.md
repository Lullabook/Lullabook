# Session Handoff — 2026-06-18: `/coder` re-run — issue 82 verification gate
...
- Binding: issues carry a Verification-command field (per updated /planner//coder skills); backfill it for pre-rule issues when picked up.
