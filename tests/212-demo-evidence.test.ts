 ...
 * and no invariant is violated — otherwise BLOCKED with each missing item named.
 *
 ...
 * COST-1 violated, and an entitlement granted through a client flag ⇒ ENT-1
 * violated. Runs the real .mjs as a subprocess so the artifact itself is tested.
 */
