  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontFamily: "var(--v2-font-display)", fontWeight: 800, fontSize: "2rem", color: "#2E2438", margin: "0 0 8px" }}>
          Create your Family
        </h1>
        <p style={{ fontSize: "0.92rem", color: "#6E6076", margin: "0 0 18px", lineHeight: 1.5 }}>
